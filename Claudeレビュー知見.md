...
## 2026-08-26本文掲載順111話・クロエ同一セッションレビュー

- 詳細正本: [本文掲載順詳細話数構成.md](本文掲載順詳細話数構成.md)
...
|---|---:|---:|---|
| R1 | 新規116章をゼロベース監査 | P1=3、P2=7、P3=11、計21 | 116話案 |
| R2 | R1の21件すべてCLOSED | P2=2、P3=2、計4 | 111話へ圧縮 |
| R3 | R2の4件すべてCLOSED | P3=2 | 番号・フック・主視点を整合 |
| R4 | R3の2件すべてCLOSED | P0〜P3=0 | 111話、全27件CLOSED |
...
収束後、詳細正本へ証拠節だけを追記したため、現行ファイルSHAはレビュー対象話数構成SHAと異なる。現在は最小単位を「話」へ名称修正したが、111話の表内容・境界は変更していない。
